  ...
  <body>
    <div id="container">
            ...
            <div id="register_page">
              ...
              <s:textfield name="user.password" label="密码" cssStyle="margin-top:15px"></s:textfield>
              <s:radio name="user.sex" label="性别" cssStyle="margin-top:15px" list="#{'M':'男','F':'女'}" listKey="key" listValue="value" value="'M'"></s:radio>
              <s:textfield name="user.phone" label="电话" cssStyle="margin-top:15px"></s:textfield>
              <s:textarea rows="3.5" cols="45" name="user.address" label="地址" cssStyle="margin-top:15px"></s:textarea>
              <td colspan="2" align="center"/><s:submit value="注册"  cssStyle="margin-top:5px"></s:submit>
              </s:form>
            </div>
            <div id="footer">
                <ul>
