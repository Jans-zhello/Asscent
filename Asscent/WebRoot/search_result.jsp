...
<html>
  ...
  <div id="title">
   ...
   <a href="account.jsp">我的账户&nbsp;&nbsp;&nbsp;</a>
    ...
    <s:submit value="注销" style="margin-let"></s:submit>
    </s:form>
    </div>
   </ul> 
  </div>	
  ...
  <div id="right">
   <div class="right_box">
	...
	<h3>
	<font color="blue">所有符合条件的药品</font>
	</h3>
	<br />
	...
	<tr>
    <td>
	价格:<s:property value="#drug.price" />元
	...
	<a href='searchdrug.action?drugname=<s:property value="#session['drugname']"/>&amp;currentPage=1'>首页</a>
	</s:if>
